<!-- Page showing only sold-out books among the books sold by the seller -->
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <%
      ...
      PreparedStatement pst = conn.prepareStatement("Select * from books where seller=? and status='sold out'");
    ...
    %>
  	...
  	<section class="list-section" id="list">
          ...
          <div class="section-title">
    				<h1>Sales Complete List</h1>
    			</div>

          <a href="./sellerUploadPage.html" class="btn btn-style">Upload Book for Sell</a>
          <a href="./sellerSalesListPage.jsp" class="btn2 btn-style">Display All Books</a>

          <!-- Table showing sales complete list information -->
