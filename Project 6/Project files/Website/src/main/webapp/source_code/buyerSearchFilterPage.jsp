<!-- Page showing only books on sale in the price range set by the buyer -->
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <%
      ...
      PreparedStatement pst = conn.prepareStatement("Select * from books where price>=? and price<=? and status='sell'");
    ...
    %>
  	...
  	<section class="booklist-section" id="booklist">
          ...
          <!-- Switch the page to display all books on market -->
